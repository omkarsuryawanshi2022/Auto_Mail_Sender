...
def MarvellousTitanicLogistic():
    ...
    countplot(data=titanic_data,x=target).set_title("Marvellous Infosystems :Survived and non survied passangers based on Gender")
    show()

    print("Visualisation: Survived and non survied passangers based on the passenger class")
    figure()
    target ="Survived"
